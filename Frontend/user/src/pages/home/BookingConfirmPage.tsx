        ...
        <div className="booking-confirm-content">
          ...
          <div className="booking-confirm-card">
            <h2 className="booking-confirm-card-title">
              <span className="card-title-icon">🏟️</span> Thông tin sân
            </h2>
            <div className="booking-confirm-card-body">
              ...
              <div className="confirm-info-row">
                ...
                <span className="confirm-info-val">{venue?.address || 'Đang tải...'}</span>
              </div>
              <div className="confirm-info-row">
          ...
          <div className="booking-confirm-card">
            <h2 className="booking-confirm-card-title">
              <span className="card-title-icon">🎟️</span> Thông tin lịch đặt
            </h2>
            <div className="booking-confirm-card-body">
              <div className="confirm-info-row">
              ...
              <div className="confirm-info-row" style={{ marginTop: 12 }}>
          ...
          {/* Block: Ưu đãi */}
          <div className="booking-confirm-promo-section">
            ...
            <div className="confirm-payment-row">
              ...
              <span className="payment-val">{totalPriceSum.toLocaleString()} đ</span>
            </div>
          </div>
